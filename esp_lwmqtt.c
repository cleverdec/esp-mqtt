...
lwmqtt_err_t esp_lwmqtt_network_wait(esp_lwmqtt_network_t *network, bool *connected,
                                     uint32_t timeout)
{
    // prepare set
    fd_set set;
    ...
    // wait for data
    struct timeval t =
    { .tv_sec = timeout / 1000, .tv_usec = (timeout % 1000) * 1000 };
...
lwmqtt_err_t esp_lwmqtt_network_select(esp_lwmqtt_network_t *network, bool *available,
                                       uint32_t timeout)
{
    // prepare set
    fd_set set;
...
lwmqtt_err_t esp_lwmqtt_network_read(void *ref, uint8_t *buffer, size_t len, size_t *read,
                                     uint32_t timeout)
{
...
lwmqtt_err_t esp_lwmqtt_network_write(void *ref, uint8_t *buffer, size_t len, size_t *sent,
                                      uint32_t timeout)
{
    // cast network reference
    esp_lwmqtt_network_t *n = (esp_lwmqtt_network_t *) ref;
